...
#it does feel nice to know something I don't want to pursue lol
...
class Raindrop:
    ...
    def move(self):
        ...
        #coding is def not for me *death*, but I'm glad I'm learning it anyway!
    def off_screen(self):
...
def main():
    ...
    while True:
        ...
        # DONE 20: As a temporary test, check if test_drop is hitting Mike (or Alyssa), if so set their last_hit_time
            ...
            #library time & function time; lol
